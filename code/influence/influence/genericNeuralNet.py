...
from influence.influence.hessians import hessian_vector_product
...
class GenericNeuralNet(object):
    ...
    def __init__(self, **kwargs):
        ...
        #added modification
        if 'elevate_loss' in kwargs: self.elevate_loss = kwargs.pop('elevate_loss')
        else: self.elevate_loss=False
    ...
    def fill_feed_dict_with_batch(self, data_set, batch_size=None):
